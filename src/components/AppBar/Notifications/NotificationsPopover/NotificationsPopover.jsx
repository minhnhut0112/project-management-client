...
const NotificationsPopover = ({ anchorEl, handleClose, open }) => {
  ...
  return (
    <Popover
      ...
      sx={{ mt: 2, boxShadow: 'none', maxHeight: 700 }}
    >
                    ...
                    .map((noti, index) => (
                      ...
                      >
                        ...
                        <Box>
                          ...
                          {noti.type === 'add' ? (
                            <Box>
                              Added you in {noti?.cardname} at {calculateTimeFromNow(noti.timestamp)}
                            </Box>
                          ) : (
                            <Box>
